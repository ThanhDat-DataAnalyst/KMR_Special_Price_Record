...
const CONFIG = {
  ...
  ADMINS: ['viet.truong@kamereo.vn','dat.pham@kamereo.vn', 'khanh.le@kamereo.vn','thanhbinh.le@kamereo.vn','hung.tran@kamereo.vn','kien.le@kamereo.vn','tranhungafd@gmail.com'],
